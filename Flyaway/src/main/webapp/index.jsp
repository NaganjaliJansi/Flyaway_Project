...
<head> 
    ...
    <style>
        ...
        .bgimg-1 {
            ...
            background-image: url("https://tds.indianeagle.com/wp-content/uploads/2018/09/Qatar-Airways.jpg");
...
<body>
    ...
    <header class="bgimg-1 w3-display-container w3-grayscale-min " id="home">
        ...
        <div class="w3-display-left w3-text-white" style="padding:48px">
            ...
            <a href="search-portal.jsp" class="w3-button w3-light-grey w3-padding-large w3-large w3-margin-top w3-opacity w3-hover-opacity-on">
